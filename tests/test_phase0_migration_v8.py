"""Tests for the v8 schema migration path retained under newer schemas.

Verifies:
- Fresh DB creation still includes all v8 columns.
- A v7 DB shape (with all v7-era tables and rows) upgrades cleanly to the current schema.
