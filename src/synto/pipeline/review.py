...
Used by `synto review` to list drafts, display diffs, and surface rejection history.
"""
...
def list_drafts(config: Config, db: StateDB) -> list[DraftSummary]:
    ...
    for draft_path in sorted(config.drafts_dir.rglob("*.md")):
        ...
        # Check for synto or legacy auto annotations in body.
        has_annotations = "<!-- synto-auto:" in body or "<!-- olw-auto:" in body
