...
Concepts are the objects this file defines (CREATE or ALTER). Use the unqualified object name as the concept name (usp_GetOrders, not dbo.usp_GetOrders). If a schema qualifier is present, put the qualified name in aliases.
